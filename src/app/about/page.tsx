  ...
  return (
    <main className="mx-auto max-w-3xl px-6 pb-24 pt-32">
      ...
      <div className="mb-12 space-y-5 text-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
        <p>
          I am a full-stack developer currently based in the Netherlands with a
          BSc in Computer Science and Engineering and a minor in Project
          ...
          React, backend services with Node.js and Java, and relational database
          design with PostgreSQL.
        </p>
        <p>
          I am drawn to environments where engineers take ownership of what they
          build and care about getting the details right. Outside of web
      ...
      <div className="mb-12">
        ...
        <div className="mb-6 space-y-3 text-zinc-600 dark:text-zinc-400">
          <p>
            ...
            shadcn/ui - building responsive, component-based interfaces with SSR
            support
          </p>
          <p>
            <span className="font-medium text-zinc-900 dark:text-zinc-50">
          ...
          <p>
            ...
            PostgreSQL, MySQL, Prisma ORM - relational data modeling, indexing,
            query optimization
          </p>
          <p>
            <span className="font-medium text-zinc-900 dark:text-zinc-50">
      ...
      <div className="mb-12">
        ...
        <div className="space-y-5 text-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
          <p>
            ...
            independently, the most substantial being a job application tracker
            with a kanban-style interface, JWT-based authentication with refresh
            token rotation, and a fully responsive React frontend. Most
            recently, I completed a migration of the Kotlin website homepage
            from a legacy Flask and React 17 stack to React Router 7 with
            server-side rendering.
          </p>
          <p>
            During my studies at TU Delft I contributed to a distributed
            conference management system built around microservices, focusing on
            API design and inter-service communication, and built a kanban-style
            task tracking application in Java with Spring and JavaFX.
          </p>
          <p>
            ...
            from scratch for a pair of AR glasses. The app was designed to help
            navy personnel manage battle damage repair scenarios on frigates,
            and was tested with real navy officers whose feedback directly
